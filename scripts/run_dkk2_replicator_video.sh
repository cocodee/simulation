...
OUTPUT_DIR="${OUTPUT_DIR:-$ROOT_DIR/outputs/dkk_2_replicator_frames}"
VIDEO_PATH="${VIDEO_PATH:-$ROOT_DIR/outputs/dkk_2_replicator_video.mp4}"
MANIFEST_PATH="${MANIFEST_PATH:-$ROOT_DIR/outputs/dkk_2_replicator_manifest.json}"
FRAMES="${FRAMES:-96}"
...
env -u CONDA_PREFIX \
  "$ISAAC_SIM_DIR/python.sh" "$ROOT_DIR/scripts/record_dkk2_replicator.py" \
    --scene "$SCENE_PATH" \
